...
part of 'my_recips_fav_store.dart';
...
mixin _$MyRecipsFavStore on MyRecipsFavBase, Store {
  late final _$statusPageAtom =
      Atom(name: 'MyRecipsFavBase.statusPage', context: context);
  ...
  late final _$getDataAsyncAction =
      AsyncAction('MyRecipsFavBase.getData', context: context);
